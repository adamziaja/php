...
//);
        ...
        $CONSUMER_KEY = "XXXXX"; // Consumer Key (API Key) VcPOH6wFt4NDWHaxQq952ao0t
        $CONSUMER_SECRET = "XXXXX"; // Consumer Secret (API Secret) PYk2cylpWFpGc3DC5kw4ek7m2datrvmdb2r16mjHEv8v3uX4TP
